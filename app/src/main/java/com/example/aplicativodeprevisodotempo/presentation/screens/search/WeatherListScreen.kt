...
import com.example.aplicativodeprevisodotempo.presentation.components.cards.WeatherCardPlaceholder
import com.example.aplicativodeprevisodotempo.presentation.components.effect.getDynamicBackgroundColor
import com.example.aplicativodeprevisodotempo.presentation.components.filter.RegionFilterBar
                            ...
                            WeatherCardModern(
                                ...
                                onFavoriteClick = {
                                    viewModel.toggleFavorite(
                                        cidadeData.city.cityName,
                                        !cidadeData.city.isFavorite
                                    )
                                }
                            )
                        }
